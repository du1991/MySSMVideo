						...
						&publishtime=${ss.publishtime}">
							...
							<script type="text/javascript">
								...
								if($("#pagein").val()==""){
									...
									$("#pageskip").attr("href","/showTV?page="+a+"&movietypedetail=${map['movietypedetail']}");
								}
							</script>
							...
							<div style="width:40%;height:300px;text-align:center;margin-left:50%">
								...
								<span><a href="/showTV?page=${map['nowPage']-1 }&movietypedetail=${map['movietypedetail']}"><button >上一页</button></a></span>
								${map['bar'] }
								<span><a href="/showTV?page=${map['nowPage']+1 }&movietypedetail=${map['movietypedetail']}"><button >下一页</button></a></span>
