...
public class GetCacheAOP  {    
    ...
    public Object beforeExec(ProceedingJoinPoint joinPoint){    
        ...
        System.out.println("从redis中查询到的对象"+objectFromRedis);
    ...
    private String getCacheKey(ProceedingJoinPoint joinPoint) {  
        ...
        //先获取目标方法参数  
        System.out.println("凭借之后"+ActionName);
        String id = null;  
        Object[] args = joinPoint.getArgs(); 
        for(int i=0;i<args.length;i++){System.out.println("joinPoint里面的参数"+args[i]);}
